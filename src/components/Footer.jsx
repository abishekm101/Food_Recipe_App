      ...
      <div className="py-16 px-4 grid lg:grid-cols-3 gap-8 text-gray-300">
        <div>
          ...
          <p>
            ...
            corporis quas, incidunt, reiciendis ratione reprehenderit labore
            magni dolor quisquam sed tenetur autem similique, vitae aperiam
            dolores cum error eos natus.
          </p>
